    ...
    <v-row>
      <v-col>
        <v-card class="primary lighten-2 mx-auto">
          <v-card-title class="text-center d-block">{{totalIncome}}</v-card-title>
      ...
      <v-col>
        <v-card class="red accent-2 mx-auto">
          <v-card-title class="text-center d-block">{{totalOutcome}}</v-card-title>
      ...
      <v-col v-if="isBalance">
        <v-card class="green accent-3 mx-auto">
          <v-card-title class="text-center d-block">{{totalIncome - totalOutcome}}</v-card-title>
